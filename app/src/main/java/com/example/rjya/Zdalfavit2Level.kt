...
data class QuestionZ(val questionText: String, val video: String, val correctAnswer: Int)

class Zdalfavit2Level : AppCompatActivity() {
    ...
    private val alphabet = listOf("Извини", "Как дела","Нет", "Плохо", "Пожалуйста", "Пока", "Помогите", "Привет", "Сегодня", "Спасибо", "Да", "Вчера", "Я не понимаю", "Утро", "Завтра", "Хорошо")

    private val questions = listOf(
        Question("Вопрос 1", "izvini.mp4", 0),//извини
        Question("Вопрос 2", "kakdela.mp4", 1),//как дела
        Question("Вопрос 3", "net.mp4", 2),//нет
        Question("Вопрос 4", "ploho.mp4", 3),//плохо
        Question("Вопрос 5", "pojailysta.mp4", 4),//Пожалуйста
        Question("Вопрос 6", "poka.mp4", 5),//пока
        Question("Вопрос 7", "pomogine.mp4", 6),//помогите
        Question("Вопрос 8", "privet.mp4", 7),//привет
        Question("Вопрос 9", "segodnya.mp4", 8),//сегодня
        Question("Вопрос 10", "spasibo.mp4", 9),//спасибо
        Question("Вопрос 11", "da.mp4", 10),//да
        Question("Вопрос 12", "vchera.mp4", 11),//вчера
        Question("Вопрос 13", "yaneponimau.mp4", 12),//я не понимаю
        Question("Вопрос 14", "ytro.mp4", 13),//утро
        Question("Вопрос 15", "zavtra.mp4", 14),//завтра
        Question("Вопрос 16", "horosho.mp4", 15),//хорошо
